...
var booksSchema = mongoose.Schema({
  ...
  approved_indicator:Boolean,
  disapproved_indicator:Boolean,
  pending_indicator:Boolean,
  author: String,
  categories: String,
  subCategory: String,
  genre: [],
...
function validateBooks(data) {
  ...
  var schema = Joi.object({
    ...
    approved_indicator:Joi.optional(),
    disapproved_indicator:Joi.optional(),
    pending_indicator:Joi.optional(),
    author: Joi.optional(),
